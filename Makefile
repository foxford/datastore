...
dep_lager = git git://github.com/erlang-lager/lager.git 3.5.2
...
dep_gunc_pool = git git://github.com/manifest/gun-connection-pool.git v0.1.2
dep_riaks2c = git git://github.com/manifest/riak-s2-erlang-client.git v0.5.0
dep_riakacl = git git://github.com/manifest/riak-acl.git v0.3.0
dep_jose = git git://github.com/manifest/jose-erlang.git v0.1.2
dep_cowboy = git git://github.com/ninenines/cowboy.git 6945882cd36223533be4e020279b31151bc8b217
